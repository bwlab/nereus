  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-lg dark:border-gray-700/50 dark:bg-gray-800/90 dark:shadow-2xl">
        {/* Accent line */}
        <div className="absolute left-0 right-0 top-0 h-[2px] bg-gradient-to-r from-primary via-cyan-400 to-teal-400" />
        ...
        <div className="px-4 pb-2 pt-3.5">
          <div className="mb-1.5 flex items-center gap-2.5">
            ...
            <div className="relative flex-shrink-0">
              <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-primary/10 to-primary/10 dark:from-primary/15 dark:to-primary/10">
                <svg className="h-3.5 w-3.5 text-primary dark:text-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
              ...
              {questions.map((_, i) => (
                <button
                  ...
                  className={`h-[3px] rounded-full transition-all duration-300 ${
                    i === currentStep
                      ? 'w-5 bg-primary dark:bg-primary'
                      : i < currentStep
        ...
        <div className="scrollbar-thin max-h-48 overflow-y-auto px-4 pb-2" role={multi ? 'group' : 'radiogroup'} aria-label={q.question}>
          <div className="space-y-1">
              ...
              return (
                ...
                >
                  ...
                  <kbd className={`flex h-5 w-5 flex-shrink-0 items-center justify-center rounded font-mono text-[10px] transition-all duration-150 ${
                    isSelected
                      ? 'bg-primary font-semibold text-white dark:bg-primary'
                  ...
                  {/* Selection check */}
                  {isSelected && (
                    <svg className="h-4 w-4 flex-shrink-0 text-primary dark:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
            ...
            >
              ...
              {isOtherOn && (
                <svg className="ml-auto h-4 w-4 flex-shrink-0 text-primary dark:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
              )}
            </button>
              ...
              <div className="pl-[30px] pr-0.5">
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border-0 bg-gray-50 px-3 py-1.5 text-[13px] text-gray-900 outline-none ring-1 ring-gray-200 transition-shadow duration-200 placeholder:text-gray-400 focus:ring-2 focus:ring-primary dark:bg-gray-900/60 dark:text-gray-100 dark:ring-gray-700 dark:placeholder:text-gray-600 dark:focus:ring-primary"
                  />
          ...
          <div className="flex items-center gap-1.5">
            ...
            {isLast ? (
              <button
                ...
                className="inline-flex items-center gap-1 rounded-lg bg-gradient-to-r from-primary to-primary px-3.5 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all duration-200 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-30 disabled:shadow-none dark:from-primary dark:to-primary"
              >
                Submit
              ...
              <button
                type="button"
                onClick={() => setCurrentStep(s => s + 1)}
                className="inline-flex items-center gap-1 rounded-lg bg-gradient-to-r from-primary to-primary px-3.5 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all duration-200 hover:shadow-md dark:from-primary dark:to-primary"
              >
                Next
                <span className="ml-0.5 font-mono text-[9px] opacity-70">Enter</span>
              </button>
