    ...
    return (
      <div className={cn('text-center py-12', className)}>
        <div className="mx-auto max-w-md">
          ...
          <div className="mb-6 rounded-lg bg-primary/5 p-4 text-left dark:bg-primary/10">
            <h4 className="mb-3 text-sm font-medium text-foreground dark:text-muted-foreground">{t('notConfigured.whatIsTitle')}</h4>
            <div className="space-y-1 text-xs text-foreground dark:text-muted-foreground">
          ...
          <button
            ...
            className="mx-auto flex items-center gap-2 rounded-lg bg-primary px-4 py-2 font-medium text-white transition-colors hover:bg-primary/90"
          >
  ...
  return (
    <div className={cn('text-center py-12', className)}>
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 rounded-xl border border-primary/20 bg-gradient-to-r from-primary/5 to-primary/5 p-6 text-left dark:border-primary/20 dark:from-primary/10 dark:to-primary/10">
