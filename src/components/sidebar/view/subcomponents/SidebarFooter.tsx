      ...
      {updateAvailable && (
        <>
          ...
          <div className="hidden px-2 py-1.5 md:block">
            ...
            >
              <div className="relative flex-shrink-0">
                <ArrowUpCircle className="h-4 w-4 text-primary dark:text-primary" />
                <span className="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 animate-pulse rounded-full bg-primary" />
              </div>
              <div className="min-w-0 flex-1">
                <span className="block truncate text-sm font-medium text-primary dark:text-primary">
                  {releaseInfo?.title || `v${latestVersion}`}
                </span>
                <span className="text-[10px] text-primary/70 dark:text-primary/60">
          ...
          <div className="px-3 py-2 md:hidden">
            ...
            >
              <div className="relative flex-shrink-0">
                <ArrowUpCircle className="w-4.5 h-4.5 text-primary dark:text-primary" />
                <span className="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 animate-pulse rounded-full bg-primary" />
              </div>
