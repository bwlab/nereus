import { Layers, Clock, Inbox, Star, Bot, Activity, Sparkles, Puzzle } from 'lucide-react';
...
const PRESET_ORDER: PresetKind[] = ['all', 'recent', 'unassigned', 'favorites', 'global-agents', 'skills', 'plugins', 'open-tabs'];
